...
class FeesToAccept extends Component {
    ...
    getFees = () => {
        axios({ 
            method: 'get',
            url: `http://localhost:8080/authentication/fee/notAccepted`,
            headers: {
    ...
    acceptFee = id => {
        axios({ 
            method: 'post',
            url: `http://localhost:8080/authentication/fee/accept/${id}`,
            headers: {
                'Authorization': localStorage.getItem('yhaToken')
            }
        })
    ...
    declineFee = id => {
        axios({ 
            method: 'delete',
            url: `http://localhost:8080/authentication/fee/decline/${id}`,
            headers: {
                'Authorization': localStorage.getItem('yhaToken')
            }
        })
